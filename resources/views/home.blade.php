                ...
                <div class="col-md-3" id="left-sidebar">
                    ...
                    <div class="follow-section">
                        <h4>Số người đang follow: <span
                                class="follow-section-txt-following">{{ $user->following_count }}</span></h4>
                        <br />
                        <h4>Số người follow: <span class="follow-section-txt-follower">{{ $user->followers_count }}</span>
                        </h4>
                        <br>
                        <h4>Số lượng video: <span class="follow-section-txt-videos">{{ $user->videos_count }}</span></h4>
                    </div>
