        ...
        <div class="bg-white text-black p-5 rounded-xl w-[450px] flex flex-col gap-5">
            ...
            <div class="flex flex-col gap-2">
                <div class="flex justify-between items-center gap-2">
                    ...
                    <p class="text-lg truncate">Videonameeeeeeeeeeeeeeeeeeeeeeeeee.mp4</p>
                </div>
                <input id="choose_video" type="file" accept=".mp4" value="" class="hidden" />
                <div class="flex flex-col gap-1">
                    <p>Mô tả:</p>
                    <textarea class="w-full rounded-lg outline-2 outline-gray-300 p-2 min-h-20"
